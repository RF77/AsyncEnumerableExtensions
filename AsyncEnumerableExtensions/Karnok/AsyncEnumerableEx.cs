...
namespace System.Linq
{
    ...
    public static partial class AsyncEnumerableEx
    {
        ...
        {
            return new Interactive.Async.Karnok.impl.Timer(delay);
        }
        ...
        /// <param name="sources">The params array of source async sequences.</param>
        /// <returns>The new IAsyncEnumerable sequence.</returns>
        public static IAsyncEnumerable<TSource> MergeConcurrently<TSource>(this IEnumerable<IAsyncEnumerable<TSource>> sources)
        {
        ...
        /// serialized async sequence. Exceptions are thrown at the end of all merged sources
        /// </summary>
        public static IAsyncEnumerable<TSource> MergeConcurrently<TSource>(this IAsyncEnumerable<TSource> firstSource, IAsyncEnumerable<TSource> secondSource,
        ...
        {
            return Interactive.Async.Karnok.impl.Empty<T>.Instance;
        }
